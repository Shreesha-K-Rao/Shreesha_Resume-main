...
const Hero = () => {
  const githubUrl = 'https://github.com/Shreesha-K-Rao'
  const linkedinUrl = 'https://www.linkedin.com/in/shreesha-krishna-rao-50438223a/'
  const emailAddress = 'raoshreeshakrishna@gmail.com'
      ...
      <div className="relative z-10 section-container text-center">
        ...
        >
          ...
          <p className="text-xl sm:text-2xl lg:text-3xl mb-6 text-amber-100">
            Software Engineer specializing in Network Automation and Data Analytics
          </p>
          <p className="text-lg sm:text-xl max-w-3xl mx-auto mb-8 text-slate-200/90">
            Results-driven software engineer with 4 years of experience in network automation and data analytics. Proficient in streamlining operations through automated workflows, data insights, and collaborative solutions.
          </p>
          ...
          <div className="grid sm:grid-cols-3 gap-4 mb-10">
            {[{
              label: 'Manual Effort Reduction', value: '70%', detail: 'Through automation workflows'
            }, {
              label: 'Inventory Accuracy', value: '45% up', detail: 'With CMDB integration'
            }, {
              label: 'Notification Efficiency', value: '78% faster', detail: 'Automated security advisories'
            }].map((stat, index) => (
              <motion.div
                key={stat.label}
